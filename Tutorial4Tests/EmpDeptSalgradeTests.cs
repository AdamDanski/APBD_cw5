...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        var departamentsInChicago = depts.Where(d=>d.Loc=="CHICAGO").Select(d=>d.DeptNo);
        List<Emp> result = emps.Where(e=>departamentsInChicago.Contains(e.DeptNo)).ToList(); 
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var result = emps
            .SelectMany(emp => grades
                .Where(g => emp.Sal >= g.Losal && emp.Sal <= g.Hisal)
    ...
    public void ShouldCalculateAverageSalaryPerDept()
    {
        ...
        var result = emps
            ...
            {
                DeptNo = g.Key,
                AvgSalary = g.Average(emp => emp.Sal),
            })
            .ToList(); 
